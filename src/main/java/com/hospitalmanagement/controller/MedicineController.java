...
public class MedicineController {
	...
	public ModelAndView goToDoctorRegisterPage() {
		...
		return new ModelAndView("addmedicine").addObject("medicineDistributorResource", medicineDistributorResource)
				.addObject("medicineCompanyResource", medicineCompanyResource);
	}
	...
	public ModelAndView searchMedicineById(@RequestParam int medicineId) {
		...
		if (medicine != null)
			...
			mv.addObject("msg", "Medicine ID Not Found For " + medicineId);
