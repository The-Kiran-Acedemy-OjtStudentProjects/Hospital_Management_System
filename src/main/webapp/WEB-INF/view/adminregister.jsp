  ...
  <div class="row mt-2">
    ...
    function myFunction() {
        ...
        if (pass1 != pass2) {
            ...
            <form action="adminregister" method="post" id="regForm" onsubmit="return myFunction()">
            <div class="row">
            ...
            <div class="row">
                 <div class="form-group ml-2">
                     ...
                     <input type="text" class="form-control" id="username" aria-describedby="emailHelp" name="username" placeholder="Enter user name.." required>
                 </div>
                  <div class="row">
            ...
            <div class="row">
             ...
             <div class="row">
                ...
                <div class="container text-center">
                      <button class="btn custom-bg text-color" ><b value="Submit">Register</b></button>
                 </div>
