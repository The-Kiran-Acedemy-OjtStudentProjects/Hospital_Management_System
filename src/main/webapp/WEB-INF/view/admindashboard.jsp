...
<body>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="card card-border" style="height: 30rem;">
							<div class="card-header text-color text-center">Todays
								Appointments</div>
							<div class="card-body text-color text-center">
 ...
 %>
					...
					<div class="col-sm-6">
						...
						<div class="card card-border" style="height: 30rem;">
							<div class="card-header text-color text-center">Patients
								Registered today</div>
							<div class="card-body text-color text-center">
								<table class="table table-responsive table-hover">
									<thead class="custom-bg">
										<tr>
					...
					<div class="col-sm-3">
						<div class="card card-border">
							<div class="card-header text-color text-center">
								<img src="resources/images/logo.png"
									class="rounded mx-auto pt-2 d-inline-block" alt="img"
									height="40px" width="40px"> <b>Appointment Taken
									today</b>
							</div>
							<div class="card-body text-color text-center">
								<h3>
					...
					<div class="col-sm-3">
						<div class="card card-border">
							<div class="card-header text-color text-center">
								<img src="resources/images/logo.png"
									class="rounded mx-auto pt-2 d-inline-block" alt="img"
									height="40px" width="40px"> <b class="ml-1">Treatment
									Done Today</b>
							</div>
							<div class="card-body text-color text-center">
		...
		.getAppointmentCountByTreatmentStatusAndBillingDate(DatabaseConstants.TreatmentStatus.DONE.value(), todayDate)%></h3>
					...
					<div class="table-responsive">
						<table class="table">
							...
							System.out.println("List Of Appointments is " + listOfAppointments);
					...
					<div class="col-sm-3">
						<div class="card card-border">
							<div class="card-header text-color text-center">
								<img src="resources/images/logo.png"
									class="rounded mx-auto pt-2 d-inline-block" alt="img"
									height="40px" width="40px"> <b class="ml-1">Distributor
									Added today</b>
							</div>
							<div class="card-body text-color text-center">
								<h3><%=distributorResource.getDistributorCountUsingRegisteredDate(todayDate)%></h3>
					...
					<div class="mt-1">
						<div class="row">
							<form class="form-inline" action="searchmedicinebyId">
								<div class="form-group">
									<input type="number" class="form-control ml-3"
										id="inputPassword2" name="medicineId"
					...
					<div class="mt-1">
						<div class="row">
							<form class="form-inline" action="searchdoctorbyId">
								<div class="form-group">
									<input type="number" class="form-control ml-3"
										id="inputPassword2" name="doctorId"
					...
					<div class="mt-1">
						<div class="row">
							<form class="form-inline" action="searchreceptionistbyId">
								<div class="form-group">
									<input type="number" class="form-control ml-3"
										id="inputPassword2" name="receptionistId"
										placeholder="Enter receptionist Id.." required>
								</div>
								<button type="submit" class="btn text-color custom-bg ml-2">Search</button>
							</form>
					...
					<div class="mt-1">
						<div class="row">
							<form class="form-inline" action="searchpharmacistbyId">
								<div class="form-group">
									<input type="number" class="form-control ml-3"
										id="inputPassword2" name="pharmacistId"
										placeholder="Enter pharmacist Id.." required>
								</div>
								<button type="submit" class="btn text-color custom-bg ml-2">Search</button>
							</form>
					...
					<div class="mt-1">
						<div class="row">
							<form class="form-inline" action="searchpatientbyId">
								<div class="form-group">
									<input type="number" class="form-control ml-3"
										id="inputPassword2" name="patientId"
					...
					<div class="col-sm-3">
						<div class="card card-border">
							<div class="card-header text-color text-center">
								<img src="resources/images/logo.png"
									class="rounded mx-auto pt-2 d-inline-block" alt="img"
									height="40px" width="40px"> <b>Todays medicine
									earning</b>
							</div>
							<div class="card-body text-color text-center">
					...
					<div class="col-sm-3">
						<div class="card card-border">
							<div class="card-header text-color text-center">
								<img src="resources/images/logo.png"
									class="rounded mx-auto pt-2 d-inline-block" alt="img"
									height="40px" width="40px"> <b>Todays treatment
									earning</b>
							</div>
							<div class="card-body text-color text-center">
								<h3>
