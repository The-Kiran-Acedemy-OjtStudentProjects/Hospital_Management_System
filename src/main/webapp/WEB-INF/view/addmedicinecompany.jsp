       ...
       <div class="col-md-4 offset-md-4 admin" >
            <div class="card">
                ...
                <div class="card-body px-5">
                    <h3 class="text-center my-3">Register Medicine Company</h3>
            <form action="addmedicinecompany" method="post">
            <div class="row">
            ...
            <div class="row">
             ...
             <div class="row">
              ...
              <div class="form-group ml-1">
                     ...
                     <input type="Date" class="form-control" id="street" aria-describedby="emailHelp" name="registerdate" value="<%=strDate %>" required>
                 </div>
                <div class="container text-center">
                      <button class="btn custom-bg text-color"><b>Add Company</b></button>
                 </div>
